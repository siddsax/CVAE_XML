...
def test(x_te, y_te, params, model=None, best_test_loss=None):
    ...
    if(best_test_loss!=None):
        ...
        print('Test Loss; Loss: {:.4}; KL-loss: {:.4}; recons_loss: {:.4}; best_loss: {:.4}; All_min1_dist: {:.4};, dist: {:.4};, dist_from_pred_y: {:.4};, dist_l1 {:.4}, dist_bce {:.4}, dist_mse {:.4};'.format(loss.data[0], \
        kl_loss, recon_loss, best_test_loss, zero_dist, dist, dist_from_pred_y, dist_l1, dist_bce, dist_mse))
